    ...
    <div className="w-full pb-24">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#E6E0D4] prose prose-stone max-w-none prose-headings:text-[#1B4332] prose-headings:font-display">
          ...
          <h2 className="text-[#1B4332] font-display font-bold text-2xl mt-8 mb-4 border-b border-[#E6E0D4]/60 pb-2">2. The Data We Collect About You</h2>
          ...
          <h2 className="text-[#1B4332] font-display font-bold text-2xl mt-8 mb-4 border-b border-[#E6E0D4]/60 pb-2">3. How We Use Your Personal Data</h2>
          ...
          <h2 className="text-[#1B4332] font-display font-bold text-2xl mt-8 mb-4 border-b border-[#E6E0D4]/60 pb-2">4. Contact Us</h2>
